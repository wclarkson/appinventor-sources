...
{ "name": "BlockyTalky",
  ...
  "properties": [{ "name": "NodeName", "editorType": "string", "defaultValue": "BlockyTalky"}],
  "blockProperties": [{ "name": "Message", "description": "Contents of message received from WebSocket.", "type": "text", "rw": "read-only"},
    { "name": "NodeName", "description": "Name of message sender", "type": "text", "rw": "write-only"}],
  "events": [{ "name": "OnMessageReceived", "description": "Message was received from WebSocket.", "params": []}
],
  "methods": [{ "name": "SendMessage", "description": "Sends a message to a BlockyTalky", "params": [{ "name": "message", "type": "text"},{ "name": "destination", "type": "text"}]}]}
,
